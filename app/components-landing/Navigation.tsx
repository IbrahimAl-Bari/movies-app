  ...
  return (
    <nav className="border-b-[6px] border-black bg-[#111111] px-6 py-2">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <button
            onClick={handleclick}
            className="border-4 border-black bg-[#FF4D4D] px-6 py-2 font-black uppercase tracking-tight text-black shadow-[6px_6px_0px_0px_#FFD60A] transition-all hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[4px_4px_0px_0px_#FFD60A]" style={{ fontWeight: 900 }}>
          Sign Up
        </button>
      </div>
    </nav>
