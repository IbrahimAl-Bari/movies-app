    ...
    return (
        <div className={"w-screen h-screen"}>
            <div className={"text-white w-full text-center h-full z-2"}>
                <Ban className={"w-20 h-20 text-[#FF4D4D] mx-auto m-6 mt-28 z-2"}/>
                <h3 className={"z-2"}> An Error Occurred</h3>
                <p className={"text-white/50 z-2"}>something went wrong, lets get you back home</p>
